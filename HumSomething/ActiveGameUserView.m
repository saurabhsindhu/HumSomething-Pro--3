...
@class CAFilter;
@implementation ActiveGameUserView
...
-(void)callRequestParsing
{
    ...
    // h ttp://humsomething.netsmartz.us/HumServices.svc/getFriendsListexceptFB/intUserID=102    
    NSURLRequest *request = [NSURLRequest requestWithURL:
                             [NSURL URLWithString:[NSString stringWithFormat:@"http://humsomething.netsmartz.us/HumServices.svc/getFriendsListexceptFB/intUserID=%@",[[myGlobalArray objectAtIndex:0] valueForKey:@"intID"]]]
...

{
        ...
        
    {
        ...
        {
            dic = [NSMutableDictionary dictionaryWithObjectsAndKeys:[resultArray objectAtIndex:0],@"IsActive",[resultArray objectAtIndex:1],@"IsPushActive",[resultArray objectAtIndex:2],@"dtCreate",[resultArray objectAtIndex:3],@"intCoins",[resultArray objectAtIndex:4],@"intFriendID",[resultArray objectAtIndex:5],@"intID",[resultArray objectAtIndex:6],@"intSticks",[resultArray objectAtIndex:7],@"intUserId",[resultArray objectAtIndex:8],@"vchEmail",[resultArray objectAtIndex:9],@"vchUserName",nil];
            //inItemElement = NO;
...
{ 
    ...
    if (tableView.tag==1) {
        ...
        if ([resultArrayFinal count]>0)
        {
            ...
            [ProfileImageButton setTitle:@"Image" forState:UIControlStateNormal];
            [ProfileImageButton setBackgroundImage:[UIImage imageNamed:@"defaultSmall@2x.png"] forState:UIControlStateNormal];
