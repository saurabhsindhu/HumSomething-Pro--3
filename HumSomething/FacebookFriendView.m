...
@class CAFilter;
@implementation FacebookFriendView
...
{
    //h ttp://humsomething.netsmartz.us/HumServices.svc/getFBFriendsList/intUserID=102
    
    
    //(@"%@",[[myGlobalArray objectAtIndex:0] valueForKey:@"intID"] );
      NSURLRequest *request = [NSURLRequest requestWithURL:
                             [NSURL URLWithString:[NSString stringWithFormat:@"http://humsomething.netsmartz.us/HumServices.svc/getFBFriendsList/intUserID=%@",[[myGlobalArray objectAtIndex:0]valueForKey:@"intID"]]]
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    [label setText:@"Facebook Friends"];
...
- (void)viewDidLoad
{
    ...
    tvFacebookFriend = [[UITableView alloc]initWithFrame:CGRectMake(10,65, 300,350) style:UITableViewStylePlain];
    tvFacebookFriend.backgroundColor =[UIColor colorWithRed:255.0f/255.0f green:228.0f/255.0f blue:187.0f/255.0f alpha:1.0f];
    tvFacebookFriend.layer.cornerRadius =6.0;
    tvFacebookFriend.layer.borderColor = [UIColor whiteColor].CGColor;
	tvFacebookFriend.layer.borderWidth = 1.0; //#import <QuartzCore/QuartzCore.h>
    tvFacebookFriend.separatorColor= [UIColor colorWithRed:255.0f/255.0f green:168.0f/255.0f blue:87.0f/255.0f alpha:1.0f];
    tvFacebookFriend.showsVerticalScrollIndicator=NO;
    tvFacebookFriend.delegate=self;
    tvFacebookFriend.dataSource=self;
    tvFacebookFriend.tag=1;
    [self.view addSubview:tvFacebookFriend];
