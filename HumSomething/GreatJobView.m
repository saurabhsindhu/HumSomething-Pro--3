...
- (void)viewDidLoad
{
    ...
    UIView *humView =[[UIView alloc]initWithFrame:CGRectMake(10,100, 300,230)];
    ...
    UIImageView *coinsImage = [[UIImageView alloc]initWithFrame:CGRectMake(260, 70, 30, 30)];
    coinsImage.backgroundColor = [UIColor clearColor];
    [coinsImage setImage:[UIImage imageNamed:@"2_coin_ico.png"]];
    [humView addSubview:coinsImage];
    

    
    UILabel *seperater1=[[UILabel alloc]initWithFrame:CGRectMake(0,60, 300, 1)];
    ...
    UILabel *lblArtistName=[[UILabel alloc]initWithFrame:CGRectMake(80,10,200, 30)];
    lblArtistName.backgroundColor=[UIColor clearColor];
    lblArtistName.font = [UIFont fontWithName:@"Helvetica-Bold" size:20.0f];
    lblArtistName.textColor=[UIColor redColor];

    lblArtistName.textAlignment=UITextAlignmentLeft;
    lblArtistName.text=@"Great Job !";
    [humView addSubview:lblArtistName];
    [lblArtistName release];
    
    UILabel *lblArtistName1=[[UILabel alloc]initWithFrame:CGRectMake(80,30, 200, 30)];
    lblArtistName1.backgroundColor=[UIColor clearColor];
    lblArtistName1.font = [UIFont fontWithName:@"Helvetica-Bold" size:20.0f];
    lblArtistName1.textColor=[UIColor redColor];
    lblArtistName1.textAlignment=UITextAlignmentLeft;
    lblArtistName1.text=@"You Earned ";
    [humView addSubview:lblArtistName1];
    [lblArtistName1 release];

    
    UILabel *lblSongName=[[UILabel alloc]initWithFrame:CGRectMake(10,70,150, 30)];
    ...
    UILabel *lblSongName1=[[UILabel alloc]initWithFrame:CGRectMake(100, 70, 200, 30)];
    ...
    lblSongName1.text=@"Song Name ";
    [humView addSubview:lblSongName1];
    [lblSongName1 release];
    
    
    UILabel *lblNumberCoins=[[UILabel alloc]initWithFrame:CGRectMake(200, 70, 100, 30)];
    lblNumberCoins.backgroundColor=[UIColor clearColor];
    lblNumberCoins.font = [UIFont fontWithName:@"Helvetica" size:16.0f];
    lblNumberCoins.textColor=[UIColor blackColor];
    lblNumberCoins.textAlignment=UITextAlignmentLeft;
    lblNumberCoins.text=@"2 Coins ";
    [humView addSubview:lblNumberCoins];
    [lblNumberCoins release];

    
    
    UILabel *lblMsg=[[UILabel alloc]initWithFrame:CGRectMake(10, 100, 280, 50)];
    lblMsg.backgroundColor=[UIColor clearColor];
    lblMsg.font = [UIFont fontWithName:@"Helvetica" size:12.0f];
    ...
    lblMsg.text=@"Would you like to try and guess the artist for two extra coins?";
    [humView addSubview:lblMsg];
    [lblMsg release];
    
    UIButton *btnYes=[UIButton buttonWithType:UIButtonTypeCustom];
    btnYes.frame=CGRectMake(80,180,40,30);
    btnYes.titleLabel.font = [UIFont fontWithName:@"Helvetica-Bold" size:14.0f];
    [btnYes setBackgroundImage:[UIImage imageNamed:@"btn_button@2x.png"] forState:UIControlStateNormal];
    [btnYes setTitle:@"Yes" forState:UIControlStateNormal];
    [btnYes setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [btnYes addTarget:self action:@selector(btnYesClicked) forControlEvents:UIControlEventTouchUpInside];
    [humView addSubview:btnYes];
    
    UIButton *btnNo=[UIButton buttonWithType:UIButtonTypeCustom];
    btnNo.frame=CGRectMake(150,180,40,30);
    btnNo.titleLabel.font = [UIFont fontWithName:@"Helvetica-Bold" size:14.0f];
    [btnNo setBackgroundImage:[UIImage imageNamed:@"btn_button@2x.png"] forState:UIControlStateNormal];
    [btnNo setTitle:@"No" forState:UIControlStateNormal];
    [btnNo setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [btnNo addTarget:self action:@selector(btnNoClicked) forControlEvents:UIControlEventTouchUpInside];
    [humView addSubview:btnNo];
