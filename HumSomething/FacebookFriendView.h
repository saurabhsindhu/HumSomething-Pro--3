...
#import "GlobalVars.h"
@interface FacebookFriendView : UIViewController<UITableViewDelegate,UITableViewDataSource,NSXMLParserDelegate>
{
    UITableView *tvFacebookFriend;
